...
export default function FarmerRouteView() {
  ...
  return (
    <div className="bg-[#0c1a0e] border border-[rgba(0,230,118,0.06)] rounded-xl p-4 space-y-3">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-bold text-[#e8f5e9]">Tu ruta de envío</h3>
      ...
      <div className="flex gap-4 text-xs">
        <div>
          ...
          <p className="font-bold text-[#e8f5e9]">{route.distance}</p>
        </div>
        <div>
          <span className="text-[#3d6b4f] font-semibold">Tiempo</span>
          <p className="font-bold text-[#e8f5e9]">{route.estimatedTime}</p>
        </div>
      </div>
