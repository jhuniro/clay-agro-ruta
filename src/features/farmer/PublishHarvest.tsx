  ...
  return (
    <>
      <button
        ...
        className="relative w-full py-5 rounded-2xl bg-gradient-to-b from-[#00e676] to-[#00a84d] text-[#050b06] font-extrabold text-lg shadow-xl shadow-[#00e676]/20 active:scale-[0.97] transition-all duration-150 flex items-center justify-center gap-3"
      >
        ...
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/70 backdrop-blur-sm">
          <div className="w-full max-w-md bg-gradient-to-b from-[#0f1f10] to-[#0a150b] border border-[rgba(0,230,118,0.08)] rounded-t-2xl sm:rounded-2xl p-6 shadow-2xl animate-[slideUp_0.3s_cubic-bezier(0.34,1.56,0.64,1)]">
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-base font-bold text-[#e8f5e9]">Publicar cosecha</h2>
              <button
                onClick={() => setOpen(false)}
                className="p-2 rounded-full bg-[rgba(255,255,255,0.04)] text-[#80cbc4] hover:bg-[rgba(255,255,255,0.08)] transition-colors"
              >
                <X size={18} />
              </button>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[rgba(0,0,0,0.3)] border border-[rgba(0,230,118,0.08)] rounded-xl px-4 py-3 text-sm text-[#e8f5e9] placeholder-[#3d6b4f] outline-none focus:border-[#00e676]/30 focus:shadow-[0_0_12px_rgba(0,230,118,0.06)] transition-all"
                />
              </div>
